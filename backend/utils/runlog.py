...
class RunLog:
    ...
    def __init__(self, provider: str, location: str, source: Optional[str] = None, meta: Optional[Dict[str, Any]] = None):
    ...
    @classmethod
    def start(cls, provider: str, location: str, source: Optional[str] = None, meta: Optional[Dict[str, Any]] = None):
