...
class SessionRealtimeTranscriptionSessionCreateResponseAudioInputTranscription(
    BaseModel
):
...
class SessionRealtimeTranscriptionSessionCreateResponseAudioInputTurnDetection(
    BaseModel
):
