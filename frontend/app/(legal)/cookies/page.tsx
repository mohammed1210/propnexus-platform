      ...
      <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-4">
            ...
            <li>Save your search filters</li>
          ...
          <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-4">
            ...
            <li>Understand user demographics (aggregated)</li>
          </ul>
          <p className="text-slate-700 dark:text-slate-300 mt-4">
            This information is collected anonymously and used only to improve our platform.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-4">
            <li>
              <strong>Supabase:</strong> For authentication and database access
            </li>
            <li>
              <strong>Stripe:</strong> For payment processing (only on checkout pages)
            </li>
            <li>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-4 mt-4">
            ...
            <li>Store temporary UI state (e.g., sidebar open/closed)</li>
        ...
        <section>
          ...
          <p className="text-slate-700 dark:text-slate-300 mb-4">
            Cookies may be either &ldquo;session&rdquo; or &ldquo;persistent&rdquo; cookies:
          </p>
          <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-300 ml-4">
            <li>
