...
function ListingsInner() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <div className={`bg-white/95 dark:bg-slate-800/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-700 sticky top-16 z-40 transition-all duration-300 ${isScrolled ? 'shadow-md' : ''}`}>
