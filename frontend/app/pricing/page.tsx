...
const PRICE_PRO =
  process.env.NEXT_PUBLIC_STRIPE_PRICE_PRO || 'price_pro_xxx';
const PRICE_INVESTOR =
  process.env.NEXT_PUBLIC_STRIPE_PRICE_INVESTOR || 'price_investor_xxx';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="border rounded p-6">
          ...
          <p className="opacity-70 mb-4">
            Everything in Pro + portfolio analytics.
          </p>
