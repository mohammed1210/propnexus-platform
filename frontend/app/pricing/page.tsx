...
export default function PricingPage() {
  return (
    <main className="max-w-5xl mx-auto px-6 py-12">
      <h1 className="text-3xl font-semibold mb-3 text-center text-blue-600 dark:text-blue-400">
        Choose your plan
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* ==== Free Tier ==== */}
        <section className="border border-zinc-200 dark:border-zinc-700 rounded-xl p-8 shadow-sm bg-white dark:bg-zinc-900 hover:shadow-md transition-shadow">
        ...
        {/* ==== Pro Tier ==== */}
        <section className="border-2 border-blue-500 rounded-xl p-8 shadow-md bg-white dark:bg-zinc-900 relative hover:shadow-lg transition-shadow">
