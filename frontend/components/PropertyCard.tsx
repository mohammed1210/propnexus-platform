...
export default function PropertyCard({ p }: { p: Property }) {
  ...
  return (
    <>
      {/*
        Use the global `card` utility to ensure a consistent look across the
        application. The `card` class applies a subtle border, rounded
        corners, appropriate background colours for light/dark modes and a
        gentle shadow. We override the default padding on the card for
        this component because the image should span the full width; the
        inner content retains its own padding via the nested div.
      */}
