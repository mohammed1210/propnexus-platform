...
export default function HeroTailwindBg() {
  return (
    <section
      aria-label="AI Deal Sourcing — PropNexus"
      className="relative bg-hero-deal bg-cover bg-center min-h-[480px] md:min-h-[560px] rounded-2xl overflow-hidden"
    >
      ...
      <div
        ...
        style={{ backgroundImage: "url('/branding/overlays/grid.svg')" }}
      />
      <div className="relative z-10 p-6 md:p-10 max-w-7xl mx-auto">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-4 text-3xl md:text-5xl font-semibold leading-tight text-white">
            Automate deal discovery and first-pass underwriting
          </h1>
          <p className="mt-4 md:mt-6 text-slate-200/90 md:text-lg">
            Ingests portals, emails, and PDFs. Scores opportunities with comp-based metrics and highlights red flags.
          </p>
