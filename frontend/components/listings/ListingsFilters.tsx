...
export default function ListingsFilters() {
  ...
  }, [q, min, max, beds, sort, dir, heatmap, selectedTypes, router]);
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-2 items-end">
            ...
            <div className="flex gap-2">
              <button
                onClick={apply}
                className="flex-1 px-4 py-2 rounded-xl bg-indigo-600 text-white font-medium hover:bg-indigo-500 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400"
              >
                Apply
              </button>
              <button
