...
import mockProperties from "./mockProperties"; // Optional local mock file if you want
...
export default function PropertiesPage() {
  ...
  // 👉 Use either API fetch or mockProperties (pick ONE)
  useEffect(() => {
    // Uncomment this if using live API
    /*
